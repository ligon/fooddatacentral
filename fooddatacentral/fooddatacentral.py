...
See https://fdc.nal.usda.gov/api-guide.html for API documentation; see https://fdc.nal.usda.gov/api-key-signup.html for API key; please also refer to the documentation provided in the README.md.
